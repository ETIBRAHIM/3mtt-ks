# Nigerian Phishing Link Detecton

A rule-based AI tool that detects Nigerian phishing scams in URLs.

## Features
- Detects fake bank links (e.g., "gtbank-update.com")
- Flags URL shorteners (bit.ly, tinyurl)
- Identifies government impersonation scams ("efcc-verify.ng")

## How It Works
1. Uses **pattern-matching algorithms** (regex)
2. Scans for Nigerian-specific scam keywords
3. Returns instant safety verdict

## Demo
```python
Enter URL: http://bit.ly/uba-verify2024
⚠️ URL SHORTENER DETECTED!
⚠️ FAKE BANK DETECTED!
